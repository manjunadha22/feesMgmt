      ...
      <div className="banner">
        <div className="banner__left">
          ...
          {/* <div className="latest__updates">
            ...
            <marquee behavior="scroll" direction="left" className="update">Latest updates here</marquee>
          </div> */}
          <div className="buttons">
            <Link to="/student"><Button variant="contained" className='btn'>Pay Fees</Button></Link><br></br>
